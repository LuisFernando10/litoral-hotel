    ...
    <?php
        ...
        class GeneralMethods
        {
            ...
            static function sendPhpMailerEmail($to = NULL, $subject = 'Contatoxxd', $message = NULL){
                ...
                //Recipients
                $mail->setFrom('luis_teste@hotellitoral.com.br', 'Luis Fernando');
                $mail->addAddress('luis_teste@hotellitoral.com.br', 'Luis Fernando');     // Add a recipient
